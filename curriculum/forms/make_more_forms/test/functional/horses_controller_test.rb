...
class HorsesControllerTest < ActionController::TestCase
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post :create, horse: { jockey_name: @horse.jockey_name, name: @horse.name, number: @horse.number, position: @horse.position }
    end
  ...
  test "should update horse" do
    put :update, id: @horse, horse: { jockey_name: @horse.jockey_name, name: @horse.name, number: @horse.number, position: @horse.position }
    assert_redirected_to horse_path(assigns(:horse))
  end
