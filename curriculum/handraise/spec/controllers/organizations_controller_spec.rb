  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved organization as @organization" do
        ...
        post :create, {:organization => { "subdomain" => "invalid value" }}, valid_session
        assigns(:organization).should be_a_new(Organization)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested organization" do
        ...
        Organization.any_instance.should_receive(:update_attributes).with({ "subdomain" => "MyString" })
        put :update, {:id => organization.to_param, :organization => { "subdomain" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the organization as @organization" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Organization.any_instance.stub(:save).and_return(false)
        put :update, {:id => organization.to_param, :organization => { "subdomain" => "invalid value" }}, valid_session
        assigns(:organization).should eq(organization)
      end
